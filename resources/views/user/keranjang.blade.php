...
<div class="site-section">
    ...
    <div class="row mb-5">
        ...
        @csrf
            ...
            <tbody>
                ...
                <td><a href="{{ route('user.keranjang.delete',['id' => $keranjang->id]) }}" class="btn btn-info btn-sm">X</a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
            </table>
    ...
    <div class="row">
        ...
        <div class="row mb-5">
            ...
            <button type="submit" class="btn btn-info btn-sm btn-block">Update Keranjang</button>
            </div>
            </form>       
        </div>
        </div>
        ...
        <div class="row justify-content-end">
            ...
            <div class="row">
                @if($cekalamat > 0)
                <div class="col-md-12">
                <a href="{{ route('user.checkout') }}" class="btn btn-info btn-lg py-3 btn-block" >Checkout</a>
                <small>Jika Merubah Quantity Pada Keranjang Maka Klik Update Keranjang Dulu Sebelum Melakukan Checkout</small>
                </div>
                @else
                <div class="col-md-12">
                <a href="{{ route('user.alamat') }}" class="btn btn-info btn-lg py-3 btn-block" >Atur Alamat</a>
