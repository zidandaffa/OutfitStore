    ...
    <div class="row mb-5">
        ...
        <div class="row mb-5">
            ...
            <div class="block-4 text-center border">
                ...
                <a href="{{ route('user.produk.detail',['id' =>  $produk->id]) }}" class="btn btn-info mt-2">Detail</a>
                </div>
            </div>
            </div>
            @endforeach
        ...
        <!-- <div class="border p-4 rounded mb-4">
            ...
            <div id="slider-range" class="border-info"></div>
            ...
            <a href="#" class="d-flex color-item align-items-center" >
                <span class="bg-info color d-inline-block rounded-circle mr-2"></span> <span class="text-black">Purple (1,075)</span>
            </a>
            </div>
