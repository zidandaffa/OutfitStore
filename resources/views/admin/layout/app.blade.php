...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><b>Outfit</b> Store</a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><b>Out</b></a>
      </div>
        ...
        <li class="nav-item {{ Request::path() === 'admin' ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.pelanggan') }}">
              <span class="menu-title"><i class="mdi mdi mdi-account-multiple menu-icon"></i> Pelanggan</span>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic1" aria-expanded="false" aria-controls="ui-basic1">
              <span class="menu-title"><i class="mdi mdi mdi-table-large menu-icon"></i> Data Master</span>
            </a>
          ...
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-title"><i class="mdi mdi-shopping menu-icon"></i> Transaksi</span>
            </a>
          ...
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic2" aria-expanded="false" aria-controls="ui-basic2">
              <span class="menu-title"><i class="mdi mdi-shopping menu-icon"></i> Pengaturan</span>
            </a>
         ...
         @yield('content')
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021 <a href="https://www.bootstrapdash.com/" target="_blank">Outfir Store</a></span>
