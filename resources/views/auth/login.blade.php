          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                  ...
                  <h3> <a class="text-info">Outfit Store</a></h3>
                ...
                <form class="pt-3" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-block btn-info font-weight-medium auth-form-btn" type="submit">SIGN IN</button>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Belum Punya Akun? <a href="/register" class="  text-info">Buat</a>
                  </div>
                </form>
              </div>
            </div>
